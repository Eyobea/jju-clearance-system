<!DOCTYPE HTML"><html>
 ...
 <?php 
    ...
    $sqlb=mysql_query("selcet * from studentcase");
...
?>
 ...
 <body>
	...
	<tr>
		...
		<td class="nav">
			<a href="manage.php"><b>..:: view Clearance ::..</b></a>
		</td>
		<td class="lio">
			<ul>
				<?php
...
<table id="content" align="center" style="width:device-width;"
										...
										<tr>
											...
											<td>
												<form action="clearance_paper.php" method="POST">
				                                   ...
				                                   <option value="End of Acadamic year">End of Acadamic year</option>
	...
	<tr >
		<td><p class="f">Copyright &copy; reserved 2014-JJU-CMS </p></td>
	</tr>
	</table>
 </body>
</html>