...
<!DOCTYPE HTML"><html>
 ...
 <body>
	...
	<tr>
		...
		<td class="nav">
			<a href="manage.php"><b>..:: Manage staff ::..</b></a>
		</td>
		<td class="lio">
			<ul>
				<?php
	...
	<tr>
		<td class="sidebar">
			...
			<div class="menuList">
				...
				<a href="issuloan.php"><span class="icon-large icon-edit"></span> &nbsp;view Issue loan</a><br/>
				<a href="addCase.php"><span class="icon-large icon-edit"></span> &nbsp;register loan</a><br/>
		...
		<td class="login_area">
			...
			<thead  >
				...
				<tbody>
					<?php	
					$all=mysql_query("select * from staffcase where procurmentOffice='$role'");
					$i=0;
					while($row=mysql_fetch_array($all))
						{	
							...
							$camp=$row['campus'];
							$stud=mysql_query("select * from staff where Idno='$id'");
