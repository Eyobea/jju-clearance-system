...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (!filter_var($unit_price, FILTER_VALIDATE_FLOAT) || $unit_price < 0) {
        ...
        $up = "UPDATE studentclearance SET department=1 WHERE stud_id='$id'";
        if (mysqli_query($conn, $up)) {
            // SQL query to insert data into the database
            $sql = "INSERT INTO departmente (name, id, Material_Id, Material_Name, Quantity, Price) VALUES ('$name', '$id', '$material_id', '$material_name', '$quantity', '$unit_price')";
...
<body>
	...
	<tr>
		...
		<td class="login_area">
				...
				<tr>
				<td class="userl">
					<p><?php echo $role ?> Department Page</p>		
				</td>
				</tr>
    </table>
    <!-- Display message -->
