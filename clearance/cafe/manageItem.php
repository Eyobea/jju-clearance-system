...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (!filter_var($unit_price, FILTER_VALIDATE_FLOAT) || $unit_price < 0) {
        ...
        $up = "UPDATE studentclearance SET cafeteria=1 WHERE stud_id='$id'";
        if (mysqli_query($conn, $up)) {
            // SQL query to insert data into the database
            $sql = "INSERT INTO cafe (name, id, Material_Id, Material_Name, Quantity, Price) VALUES ('$name', '$id', '$material_id', '$material_name', '$quantity', '$unit_price')";
...
<body>
    <h4><a href="officer.php">bacck to home</a></h4>
