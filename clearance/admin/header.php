...
<html>
 <head>
	<title>JIGJIGA University Student Clearance Management System</title>
	<meta charset="UTF-8">
 ...
 <body>
 <a href="#">
<table id="banner" align="center" style="width:device-width;background:brown; color:white;" >
	<tr>
		<th class="logo">
			<img src="image/logo.png" height="50%" width="25%"/>
			<p>Where Aims Become Achivement !</p>
		</th>		
		<th class="jju">
			<p>Jigjiga University <br/>Online Clearance Management System</p>
		</th>		
