...
<table id="content" align="center" style="width:device-width;"
    ...
    <a href="chengepassword.php"><span class="icon-large icon-question-sign"></span> &nbsp; Changepassword</a></br>				
		...
		<td class="login_area">
			...
			<thead>
				<thead >
					<tr  bgcolor="lightblue"><th border="1" colspan="3" style="bgcolor:lightblue"><font>Change password</font><a href="admin.php"><span style="color:red;margin-left:60%;" class="icon-large icon-remove" align="right" title="close"></span></a></th></tr>
				<tr>
