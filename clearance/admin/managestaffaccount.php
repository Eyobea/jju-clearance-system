<!DOCTYPE HTML"><html>
 ...
 <body>
	...
	<tr>
		...
		<td class="nav">
			<a href="registrar.php"><b>..:: Admin Page ::..</b></a>
		</td>
		<td class="lio">
			<ul>
				<?php
...
<table id="content" align="center" style="width:device-width;"
    ...
    <a href="chengepassword.php"><span class="icon-large icon-question-sign"></span> &nbsp; Changepassword</a></br>				
		...
		<td class="login_area">
					<table width="100%"><tr>
			<td class="userl">
				<p><?php echo $role ?>strator page</p>		
			</td>
			</tr>
			</table>
			...
			<span style="box-shadow:0px 0px 20px #336699;padding:10px 5%;border-radius:5px;color:white;border:1px solid red;"><a href="managestaffaccount.php">manage staff account</a></span>
		...
		<?php
				...
				$count=mysql_num_rows($result);
					...
					while($row = mysql_fetch_array($result))
				  {
					...
					if($stat==0){
					echo"<td style='height:30px;' align = 'center' width = '1'><a href = 'deactsf.php?enable=".$id."'><span style='border:1px solid transparent;padding:5px;border-radius:5px;color:white;background-color:green;' title='enabled' onclick='isendis();'>Activated</span></a></td>";
				}
				else
				{
				echo"<td style='height:30px;' align = 'center' width = '1'><a href = 'actsf.php?disable=".$id."'><span style='border:1px solid transparent;padding:5px;border-radius:5px;color:white;background-color:red;' title='disabled' onclick='isendis();'>Deactivated</span></a></td>";
				}
				
					echo"<td style='height:30px;' align = 'center' width = '1'><a href = 'resetsf.php?reset=".$id."'><span style='border:1px solid transparent;padding:5px;border-radius:5px;color:white;background-color:red;' title='Delete' onclick='isdelete();'>reset</span></a></td>";
