		...
		<?php
				...
				$count=mysql_num_rows($result);
					...
					while($row = mysql_fetch_array($result))
				  {
					...
					if($stat==0){
					echo"<td style='height:30px;' align = 'center' width = '1'><a href = 'deactof.php?enable=".$id."'><span style='border:1px solid transparent;padding:5px;border-radius:5px;color:white;background-color:green;' title='enabled' onclick='isendis();'>Activated</span></a></td>";
				}
				else
				{
				echo"<td style='height:30px;' align = 'center' width = '1'><a href = 'actof.php?disable=".$id."'><span style='border:1px solid transparent;padding:5px;border-radius:5px;color:white;background-color:red;' title='disabled' onclick='isendis();'>Deactivated</span></a></td>";
				}
