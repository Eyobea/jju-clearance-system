...
<table id="content" align="center" style="width:device-width;">
    ...
    <table id="footer" align="center" style="width:device-width;">
        <tr>
            <td>
                <button onclick="saveAndPrintForm()">Save and Print</button>
            </td>
        </tr>
    </table>
    ...
    <script>
        function saveAndPrintForm() {
            // Add code here to save the form data
            // Example: You can use AJAX to send the form data to a server-side script to save it to a database

            // After saving the form data, you can trigger the print action
            window.print();
        }
    </script>
    <table id="footer" align="center" style="width:device-width;">
